...
The benefit of this structure is that adding and removing elements is very easy once you have an element, as you can simply a change where the memory addresses point to. 
...
Linked lists don’t require a large set of contiguous memory to be set aside either, no so copying arrays or element rejigging is ever needed to maintain the structure.
