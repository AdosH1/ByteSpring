...
description: The use of exceptions vs. result types is a controversial topic that has sparked strong feelings on both sides of the fence. Kotlin's unique history has subtley shifted its developers a certain way, and in this article I will share my opinon on how developers should handle exceptions and control flow in Kotlin. 
