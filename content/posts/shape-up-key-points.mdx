---
title: Shape Up - Key Concepts
description: The key concepts differentiating shape up from agile
date: "2023-08-01"
---
...
The chances are, the less valuable ideas will naturally remove themselves from betting table. 
For example, a bug that happened once but is never brought up again will naturally be left alone whereas a consistent (and valuable) issue will be brought up by interested stakeholders. 
...
This button takes up page real estate, and in our own testing we realise users will find it unintuitive to have the button in that area and worse, there's no space in the section on mobile!
...
However, a developer given the **_project of implementing the UI for users_** has the freedom to adjust the implementation by putting the UI in a submenu and still delivering the project scope.

---

If you’re interested in knowing more about the Shape Up methodology, you may find the book freely available [here](https://basecamp.com/shapeup).
