...
There are a _lot of AWS services_, and while studying for the _AWS Solutions Architect Associate (SAA-03)_ exam, it felt like there was a new service in every question.
...
- AWS services and exam question tips relating to:
    - Compute services
    - Security services
    - Storage services
    - Networking services
...
- Exam studying material and strategy
...
## Studying Material and Strategy
I wrote this article as a guide that optimizes for _**speed passing the test**_ and not for _**deeply learning how AWS works**_.
I completed this exam from start to finish in _4 weeks_ without prior AWS knowledge, and did so by exclusively doing exams and working backwards.

For those time sensitive and just require this certification for work, or already have some cloud experience _(but not for AWS)_,
then this was my strategy to obtaining my AWS SAA-03 certification.

### Tutorials Dojo
The Tutorials Dojo practice exams were by far the _**closest I found to the actual exam questions and highly recommended**._
The main drawback I found was the _limited number of questions available_, especially for someone who is learning only through exams.

There are 6 exams worth of questions total + a bonus final exam. 
Each question has a relatively decent explanation with enough details that at most you'll only need to google to clarify a service.
My strategy was to take each exam to the best of my ability _(even if I fail the first ones)_, 
and spend a signicant amount of time reviewing and reasoning the differences between services.

I'd eventually build up a mental model similar to the diagrams I've created above.
I'd recommend to _**aim for a 90% on a timed exam that you haven't seen before**._ 
_That might seem high, but I believe this is the **minimum understanding** needed to actually pass the AWS exam._

If you're using any other AWS learning materials, I'd recommend saving a couple Tutorials Dojo exams to do after that material just to _confirm the 90% pass_ as I've found this to be a good indicator.  
If you're interested in Tutorials Dojo practice exams and want to support my blog, you may find the exams [here](https://portal.tutorialsdojo.com/product/aws-certified-solutions-architect-associate-practice-exams/ref/177316)
_(this is the only material I'd recommend to you from my experience)._

### WhizLabs
WhizLabs have a lot of questions, but of lower quality in terms of exam relevance and even correctness.
I found some practice questions far too detailed and in-depth for what is actually tested, 
and ended up spending a lot of time that could've been used elsewhere.

After completing the WhizLabs exams, 
I found myself much more confident in Tutorials Dojo exams due to the depth of knowledge I needed to pass the WhizLab exams.
However, I don't believe this materially expressed itself in the actual exam.

### Cantrill AWS Course
Cantrill is a ~70+ hour course that will take double that amount to actually go through because it is very hands on and teaches best practices on how to _**actually use AWS**._  
The content is great for properly learning AWS but for the time sensitive, I would not recommend this approach.
Each section does have exam relevant quiz questions _(with accompanying videos to explain)_, though it is up to you whether that is worth spending $40 for.
